...
public class FrostedTotemSpirit<T extends FrostedTotemSpiritEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData totem_spirit = modelPartData.addChild("frosted_totem_spirit", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
	...
	@Override
	public void setAngles(FrostedTotemSpiritEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		frosted_totem_spirit.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}

	@Override
	public ModelPart getPart() {
		return frosted_totem_spirit;
	}
