...
public class TotemSpiritAttackGoal extends MeleeAttackGoal {
    private final TotemSpiritEntity entity;
    private int attackDelay = 17;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;

    public TotemSpiritAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((TotemSpiritEntity) mob);
    }
    @Override
    public void start() {
        super.start();
