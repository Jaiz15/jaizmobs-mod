...
public class DripletAttackGoal extends MeleeAttackGoal {
    private final DripletEntity entity;
    private int attackDelay = 17;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;

    public DripletAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((DripletEntity) mob);
    }
    @Override
    public void start() {
        super.start();
