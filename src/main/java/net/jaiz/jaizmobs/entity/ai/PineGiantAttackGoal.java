...
public class PineGiantAttackGoal extends MeleeAttackGoal {
    private final PineGiantEntity entity;
    private int attackDelay = 15;
    private int ticksUntilNextAttack = 5;
    private boolean shouldCountTillNextAttack = false;

    public PineGiantAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((PineGiantEntity) mob);
    }
