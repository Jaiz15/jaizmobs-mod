...
public class FrostedTotemSpiritAttackGoal extends MeleeAttackGoal {
    private final FrostedTotemSpiritEntity entity;
    private int attackDelay = 17;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;

    public FrostedTotemSpiritAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((FrostedTotemSpiritEntity) mob);
    }
    @Override
    public void start() {
        super.start();
