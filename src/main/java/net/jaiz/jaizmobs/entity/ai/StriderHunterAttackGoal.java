...
public class StriderHunterAttackGoal extends MeleeAttackGoal {
    private final StriderHunterEntity entity;
    private int attackDelay = 17;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;

    public StriderHunterAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((StriderHunterEntity) mob);
    }
    @Override
    public void start() {
        super.start();
