...
public class HunterEelAttackGoal extends MeleeAttackGoal {
    private final HunterEelEntity entity;
    private int attackDelay = 17;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;

    public HunterEelAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((HunterEelEntity) mob);
    }
    @Override
    public void start() {
        super.start();
