...
public class DripletEntity extends HostileEntity {

    private static final TrackedData<Boolean> ATTACKING =
            DataTracker.registerData(DripletEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public DripletEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    protected void initCustomGoals() {
        ...
        this.goalSelector.add(1, new DripletAttackGoal(this, 1D, true));
    ...
    public static DefaultAttributeContainer.Builder createDripletAttributes() {
